# Automated maintenance for LitServe

This public portfolio copy is maintained by [FrankieGhaf](https://github.com/FrankieGhaf). The original project is [Lightning-AI/LitServe](https://github.com/Lightning-AI/LitServe); its authors retain credit for their work. Original license and notice files and the default branch's Git history are preserved.
...
```sh
sudo -Hu frankieghaf /usr/bin/python3 /home/frankieghaf/bin/sync_repositories.py --repo LitServe
```
